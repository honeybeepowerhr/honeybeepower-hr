...
const PRODUCTS_FEED_DATA = [
  {
    ...
    imageLink: 'https://planetbio.hr/images/products/gellimun-prednja.png',
    price: '2.49 EUR',
  ...
  },
  {
    ...
    imageLink: 'https://planetbio.hr/images/products/isolimun-prednja.png',
    price: '11.99 EUR',
    availability: 'in_stock',
    brand: 'Honey Bee Power',
    gtin: '3851234567891',
  },
  {
    ...
    imageLink: 'https://planetbio.hr/images/products/paketgellimun-new.png',
    price: '30.00 EUR',
    availability: 'in_stock',
    brand: 'Honey Bee Power',
    gtin: '3851234567892',
