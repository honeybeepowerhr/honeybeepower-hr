...
const COPY: Record<Locale, { title: string; description: string }> = {
  hr: {
    ...
    description:
      'Prirodni energetski gelovi i izotonični napitci na bazi 100% cvjetnog meda — bez sukraloze i umjetnih aditiva. Proizvedeno u Hrvatskoj, dostava diljem regije.',
  },
  en: {
    title: 'Honey Bee Power — Natural Honey-Based Sports Nutrition',
    description:
      'Natural energy gels and isotonic drinks made with 100% flower honey — no sucralose, no artificial additives. Made in Croatia, shipped across Europe.',
  },
  de: {
    title: 'Honey Bee Power — Natürliche Sporternährung auf Honigbasis',
    description:
      'Natürliche Energiegels und isotonische Getränke aus 100% Blütenhonig — ohne Sucralose, ohne künstliche Zusätze. Hergestellt in Kroatien.',
  },
  sl: {
    title: 'Honey Bee Power — Naravna Športna Prehrana na Osnovi Medu',
    description:
      'Naravni energijski geli in izotonični napitki na osnovi 100 % cvetličnega medu — brez sukraloze in umetnih dodatkov. Izdelano na Hrvaškem.',
  },
  pl: {
    title: 'Honey Bee Power — Naturalne Odżywki Sportowe na Bazie Miodu',
    description:
      'Naturalne żele energetyczne i napoje izotoniczne na bazie 100% miodu kwiatowego — bez sukralozy i sztucznych dodatków. Produkowane w Chorwacji.',
  },
}
