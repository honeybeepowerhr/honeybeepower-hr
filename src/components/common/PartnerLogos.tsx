  ...
  return (
    <div className={className}>
      ...
      <div className="max-w-xs mx-auto mb-8">
        <div className="relative rounded-3xl bg-white border-2 border-amber-400 shadow-lg shadow-amber-100 px-8 py-6 flex flex-col items-center gap-3">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 max-w-4xl mx-auto">
        {REST.map((partner) => (
          <div
            key={partner.key}
            className="group rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 p-4 flex flex-col items-center gap-2"
          >
