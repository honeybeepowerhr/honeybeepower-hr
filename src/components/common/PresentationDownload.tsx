...
export function PresentationDownload({ className = '' }: PresentationDownloadProps) {
  ...
  return (
    <div
      className={`flex flex-col sm:flex-row items-center gap-5 bg-charcoal text-white rounded-3xl p-6 sm:p-8 ${className}`}
    >
      ...
      <a
        href={href}
        download
        className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-sm transition-colors flex-shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300"
      >
